      ...
      <div className="max-w-6xl mx-auto px-4 py-10 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-default-600">
              I am a passionate web developer committed to crafting innovative
              and user-centric solutions. My portfolio highlights my expertise
              in web development and design, showcasing projects that blend
              creativity, functionality, and modern technologies.
            </p>
          </div>
          <div className="flex flex-col space-y-4">
        ...
        <div className="mt-8 pt-8 border-t border-default-200">
          <p className="text-sm text-center text-default-600">
            © {new Date().getFullYear()} Md Solaiman. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
